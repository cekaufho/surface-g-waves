...
data = xarray.open_dataset("17dec2020_5.cdf")
...
ax = sns.heatmap(w[-1, 1, :, :], annot=False, fmt=".1f", cmap="viridis_r", vmin=0, vmax=0.2, cbar_kws={'label': 'Colourbar Kwargs'}) # annot = True gives actual depth numbers for the boxes
