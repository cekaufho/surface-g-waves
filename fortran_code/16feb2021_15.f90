...
do i = is_pe, ie_pe
    do j = js_pe, je_pe
        if (i == 40 .AND. j .LE. 29 ) kbot(i, j) = 0
        if (i== 40 .AND. j .GE. 29+6 .AND. j .LE. 29+6+30) kbot(i, j) = 0
        if (i ==40 .AND. j .GE. 29+6+30+6) kbot(i, j) = 0
    enddo
enddo
...
!do i = is_pe, ie_pe
!    do j = js_pe, je_pe
!        if (i == 40 .AND. j .LE. 46 ) kbot(i,j) = 0
!                if (i == 40 .AND. j .GE. 46+8 ) kbot(i,j) = 0
!    enddo
!enddo
